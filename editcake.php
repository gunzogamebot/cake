<?php 
    ...
    if (isset($_REQUEST['btn_update'])) {
        try {
            ...
            if (!isset($errorMsg)) {
                $update_stmt = $conn->prepare("UPDATE tbl_cake SET cake_name = :cake_name_up, cake_details = :cake_details_up, cake_price = :cake_price_up, image = :file_up WHERE cake_id = :cake_id");
                $update_stmt->bindParam(':cake_name_up', $cake_name);
                $update_stmt->bindParam(':cake_details_up', $cake_details);
                $update_stmt->bindParam(':cake_price_up', $cake_price);
                $update_stmt->bindParam(':file_up', $image_file);
                $update_stmt->bindParam(':cake_id', $cake_id);
    ...
    <div class="container text-center">
        ...
        <div class="form-group">
            ...
            <div class="mb-3 col-sm-5">
                <input type="text" name="txt_name" class="form-control" value="<?php echo $cake_name; ?>">
            </div>
            ...
            <div class="mb-3 col-sm-5">
                <input type="text" name="txt_price" class="form-control" value="<?php echo $cake_price; ?>">
            </div>
