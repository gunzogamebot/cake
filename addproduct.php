<?php 
    ...
    if (isset($_REQUEST['btn_insert'])) {
        try {
            ...
            if (!isset($errorMsg)) {
                $insert_stmt = $conn->prepare('INSERT INTO tbl_product(pro_name, pro_price, image) VALUES(:fname, :fprice, :fimage)');
                $insert_stmt->bindParam(':fname', $pro_name);
                $insert_stmt->bindParam(':fprice', $pro_price);
            ...
            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <a href="toppings.php" class="btn btn-danger">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
