...
<body>
            ...
            <div class="container">
                <div class="nav-con">
                    ...
                    <ul class="menu">
                        ...
                        <!-- <a href="logout.php" class="out-btn" id="register">ออกจากระบบ</a> -->
                ...
                <table class="table table-bordered border-info">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="addlist_order.php?update_id=<?php echo $row['cake_id']; ?>" class="btn btn-success">สั่งซื้อ</a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
        ...
        <div class="row">
            ...
            <div class="card-body">
                ...
                <hr class="my-3">
                <a href="addlist_order.php?update_id=<?php echo $row['cake_id']; ?>" class="btn btn-success">สั่งซื้อ</a>
            </div>
            </div>
            </div>
            <?php } ?>
